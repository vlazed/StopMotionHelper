...
function PANEL:Init()
    ...
    self.FileName.Label:SetDark(true)
...
function PANEL:DoDelete()
    ...
    promptpanel.Label:SetDark(true)
...
function PANEL:SaveExists(names)
    ...
    overwritepanel.ScrollPanel.Text:SetDark(true)
...
function PANEL:AppendWindow(savenames, gamenames)
    ...
    appendpanel.ScrollPanel.NameLeft:SetDark(true)
    ...
    appendpanel.ScrollPanel.NameRight:SetDark(true)
    ...
    for id, name in ipairs(savenames) do
        ...
        appendpanel.ScrollPanel.SaveNames[id].Label:SetDark(true)
    ...
    for id, name in ipairs(gamenames) do
        ...
        appendpanel.ScrollPanel.GameNames[id].Label:SetDark(true)
